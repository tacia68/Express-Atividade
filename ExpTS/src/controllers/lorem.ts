...
const serverLorem = async (req: Request, res: Response) => {
    ...
    if (url === '/lorem') {
      // Rota '/lorem': Renderiza o template 'app/lorem'
      res.statusCode = 200;
      ...
      // Rota '/lorem?count=<number>': Gera Lorem Ipsum com o número de parágrafos especificado
      ...
      // Outras rotas: Serve arquivos estáticos
